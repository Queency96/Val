        ...
        <table className='w-full'>
          ...
          <thead className='bg-gray-50 border-b'>
            <tr className='text-left'>
              ...
              <th className='px-5 py-4 font-semibold text-gray-700'>Product</th>

              <th className='px-5 py-4 font-semibold text-gray-700'>SKU</th>

              <th className='px-5 py-4 font-semibold text-gray-700'>
                Category
              </th>

              <th className='px-5 py-4 font-semibold text-gray-700'>Brand</th>

              <th className='px-5 py-4 font-semibold text-gray-700'>Price</th>

              <th className='px-5 py-4 font-semibold text-gray-700'>Stock</th>

              <th className='px-5 py-4 font-semibold text-gray-700'>Sold</th>
